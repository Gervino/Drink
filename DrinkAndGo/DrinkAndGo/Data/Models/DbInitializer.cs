                ...
                if (!context.Drinks.Any())
                {
                    ...
                    (
                        ...
                        new Drink
                        {
                            ...
                            Category = Categories["Alcoholic"],
                            ImageUrl = "http://img.youtube.com/vi/eLlfZWg7qBA/0.jpg",
                            InStock = true,
                            IsPreferredDrink = false,
                            ImageThumbnailUrl = "http://img.youtube.com/vi/eLlfZWg7qBA/0.jpg"
                        },
                        ...
                        new Drink
                        {
                            ...
                            Category = Categories["Alcoholic"],
                            ImageUrl = "http://img.youtube.com/vi/_8R67DEDHL4/0.jpg",
                            InStock = true,
                            IsPreferredDrink = false,
                            ImageThumbnailUrl = "http://img.youtube.com/vi/_8R67DEDHL4/0.jpg"
                        },
                        ...
                        new Drink
                        {
                            Name = "Arancia ",
                            Price = 5.95M,
                            ShortDescription = "succo di arancia naturale",
                            LongDescription = "succo di arancia giallo fatto in modo artigianale con un profondo rispetto delle norme di salute",
                            Category = Categories["Non-Alcoholic"],
                            ImageUrl = "http://img.youtube.com/vi/AbUC_iN18mY/0.jpg",
                            InStock = true,
                            IsPreferredDrink = true,
                            ImageThumbnailUrl = "http://img.youtube.com/vi/AbUC_iN18mY/0.jpg"
                        },
                        ...
                        new Drink
                        {
                            Name = "Ananas",
                            Price = 7.95M,
                            ShortDescription = "succo di ananas naturale",
                            LongDescription = "succo di ananas giallo fatto in modo artigianale con un profondo rispetto delle norme di salute",
                            Category = Categories["Non-Alcoholic"],
                            ImageUrl = "http://img.youtube.com/vi/UJ0M__w-IaU/0.jpg",
                            InStock = true,
                            IsPreferredDrink = true,
                            ImageThumbnailUrl = "http://img.youtube.com/vi/UJ0M__w-IaU/0.jpg"
                        },
                        ...
                        new Drink
                        {
                            ...
                            Category = Categories["Alcoholic"],
                            ImageUrl = "http://img.youtube.com/vi/RKUXeQf0-_Q/0.jpg",
                            InStock = true,
                            IsPreferredDrink = false,
                            ImageThumbnailUrl = "http://img.youtube.com/vi/RKUXeQf0-_Q/0.jpg"
                        }
                    );
                }
